  ...
  return (
    <>
      <div className="text-center text-secondary m-5 border border-danger">
        ...
        <h2 className="text-secondary text-center h3 text-success">October 2024</h2>
      </div>
      ...
      <div className="row text-center text-secondary m-3 border border-success">
        ...
        <div className="col-lg-6">
          <div className="text-center text-secondary p-lg-5 mx-auto border border-warning w-75">
            <h1>IMAGES</h1>
            <Carousel>
              <Carousel.Item>
                <img
