  ...
  return (
    <>
      <div className="text-center text-secondary m-5 border border-danger">
        ...
        <p className="text-secondary text-center h3 text-success">May 2024</p>
      </div>
      ...
      <div className="row text-center text-secondary m-3 border border-success">
        ...
        <div className="col-lg-6">
          <div className="text-center text-secondary center p-lg-5 mx-auto border border-danger w-75">
            <h1>IMAGES</h1>
            <Carousel>
              <Carousel.Item>
                <img
